...
<template>
  ...
  >
    ...
    >
      <UCard
        :ui="{
          root: 'ring-1 ring-monokai-blue/20',
          body: 'p-3 sm:p-3'
        }"
      >
        <div class="flex items-center gap-3">
          <!-- Drag handle -->
          <button class="drag-handle cursor-grab active:cursor-grabbing text-monokai-gutter hover:text-gray-600 shrink-0">
          ...
          <div class="min-w-0 flex-1">
            <div class="flex items-center gap-2 flex-wrap">
              ...
              <span class="text-[13px] text-monokai-gutter">{{ getRegistryEntry(flatItem.item.registryName)?.registryPackage.replace('@wordpress/', '@wp/') }}</span>
              <UBadge
            ...
            <div
              ...
              class="text-xs text-monokai-gutter  truncate mt-0.5"
            >
