...
<template>
  <div>
    ...
    <p class="text-sm text-monokai-gutter  mb-8">
    ...
    >
      <div class="space-y-10">
        ...
        <div>
          ...
          <p class="text-sm text-monokai-gutter  mb-5">Control where this block can appear and what it allows inside.</p>
          <div class="space-y-5">
            <UFormField
              label="Parent Blocks"
              name="parent"
        ...
        <div>
          ...
          <p class="text-sm text-monokai-gutter  mb-5">Core editor capabilities for this block.</p>
          <div class="space-y-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                <div>
                  <p class="text-sm font-medium">Anchor</p>
                  <p class="text-xs text-monokai-gutter ">Exposes HTML anchor control</p>
                </div>
              ...
              <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                <div>
                  ...
                  <p class="text-xs text-monokai-gutter ">Allow wide alignment if theme supports it</p>
                </div>
              ...
              <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                <div>
                  ...
                  <p class="text-xs text-monokai-gutter ">Auto-add <code class="text-xs">.wp-block-*</code> class</p>
                </div>
              ...
              <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                <div>
                  ...
                  <p class="text-xs text-monokai-gutter ">Show "Additional CSS class" field in Advanced</p>
                </div>
              ...
              <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                <div>
                  ...
                  <p class="text-xs text-monokai-gutter ">Allow editing block HTML directly</p>
                </div>
              ...
              <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                <div>
                  ...
                  <p class="text-xs text-monokai-gutter ">Display block in the inserter</p>
                </div>
              ...
              <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                <div>
                  ...
                  <p class="text-xs text-monokai-gutter ">Allow multiple instances per post</p>
                </div>
              ...
              <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                <div>
                  ...
                  <p class="text-xs text-monokai-gutter ">Allow conversion to reusable block</p>
                </div>
              ...
              <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                <div>
                  ...
                  <p class="text-xs text-monokai-gutter ">Allow user to change lock state</p>
                </div>
              ...
              <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                <div>
                  ...
                  <p class="text-xs text-monokai-gutter ">Allow user to rename the block</p>
                </div>
              ...
              <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                <div>
                  ...
                  <p class="text-xs text-monokai-gutter ">Enable split on Enter / paste</p>
                </div>
                <USwitch v-model="state.supports!.splitting" aria-label="Enable splitting support" />
              </div>
            </div>

            <div class="p-3 rounded-md border border-monokai-blue/20">
              <p class="text-sm font-medium mb-1">Alignment Options</p>
              <p class="text-xs text-monokai-gutter  mb-3">Select which alignment values to enable. None = disabled, all = <code class="text-xs">true</code>, partial = array.</p>
        ...
        <div>
          ...
          <p class="text-sm text-monokai-gutter  mb-5">Color picker controls exposed in the editor sidebar.</p>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                <p class="text-sm font-medium">Text Color</p>
                <p class="text-xs text-monokai-gutter ">Text color picker</p>
              </div>
            ...
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                ...
                <p class="text-xs text-monokai-gutter ">Background color picker</p>
              </div>
            ...
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                ...
                <p class="text-xs text-monokai-gutter ">Color picker for <code class="text-xs">&lt;a&gt;</code> elements</p>
              </div>
            ...
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                ...
                <p class="text-xs text-monokai-gutter ">Gradient picker for background</p>
              </div>
            ...
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                ...
                <p class="text-xs text-monokai-gutter ">Color picker for heading elements</p>
              </div>
            ...
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                ...
                <p class="text-xs text-monokai-gutter ">Color picker for button elements</p>
              </div>
        ...
        <div>
          ...
          <p class="text-sm text-monokai-gutter  mb-5">Typography controls exposed in the editor sidebar.</p>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                <p class="text-sm font-medium">Font Size</p>
                <p class="text-xs text-monokai-gutter ">Font size picker control</p>
              </div>
            ...
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                ...
                <p class="text-xs text-monokai-gutter ">Line height control</p>
              </div>
              <USwitch v-model="state.supports!.typography!.lineHeight" aria-label="Enable line height support" />
            </div>

            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20 sm:col-span-2">
              <div>
                <p class="text-sm font-medium">Text Align</p>
                <p class="text-xs text-monokai-gutter ">Text alignment toolbar (left / center / right)</p>
              </div>
        ...
        <div>
          ...
          <p class="text-sm text-monokai-gutter  mb-5">Margin and padding controls. Optionally restrict to specific sides or axes.</p>
          <div class="space-y-4">
            <div class="p-3 rounded-md border border-monokai-blue/20 space-y-3">
              <div class="flex items-center justify-between gap-3">
                <div>
                  <p class="text-sm font-medium">Margin</p>
                  <p class="text-xs text-monokai-gutter ">Enable margin controls</p>
                </div>
                <USwitch v-model="marginEnabled" aria-label="Enable margin support" />
              </div>
              <div v-if="marginEnabled" class="flex flex-wrap gap-4 pt-1 border-t border-gray-100">
                <label
            ...
            <div class="p-3 rounded-md border border-monokai-blue/20 space-y-3">
              <div class="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p class="text-xs text-monokai-gutter ">Enable padding controls</p>
                </div>
                <USwitch v-model="paddingEnabled" aria-label="Enable padding support" />
              </div>
              <div v-if="paddingEnabled" class="flex flex-wrap gap-4 pt-1 border-t border-gray-100">
                <label
                  v-for="side in spacingSideOptions"
                  :key="side.value"
                  class="flex items-center gap-2 cursor-pointer mt-2"
        ...
        <div>
          ...
          <p class="text-sm text-monokai-gutter  mb-5">Dimension controls exposed in the editor sidebar.</p>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                <p class="text-sm font-medium">Min Height</p>
                <p class="text-xs text-monokai-gutter ">Minimum height control</p>
              </div>
            ...
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                ...
                <p class="text-xs text-monokai-gutter ">Aspect ratio control</p>
              </div>
        ...
        <div>
          ...
          <p class="text-sm text-monokai-gutter  mb-5">Border controls exposed in the editor sidebar.</p>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                <p class="text-sm font-medium">Border Radius</p>
                <p class="text-xs text-monokai-gutter ">Corner radius control</p>
              </div>
            ...
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                ...
                <p class="text-xs text-monokai-gutter ">Border color picker</p>
              </div>
            ...
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                ...
                <p class="text-xs text-monokai-gutter ">Border width control</p>
              </div>
            ...
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                ...
                <p class="text-xs text-monokai-gutter ">Border style (solid, dashed, dotted)</p>
              </div>
        ...
        <div>
          ...
          <p class="text-sm text-monokai-gutter  mb-5">Layout controls for container blocks. Enable to reveal sub-options.</p>
          <div class="space-y-4">
            <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
              <div>
                <p class="text-sm font-medium">Enable Layout Support</p>
                <p class="text-xs text-monokai-gutter ">Enables layout controls for container blocks</p>
              </div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                  <div>
                    ...
                    <p class="text-xs text-monokai-gutter ">Switcher for layout types</p>
                  </div>
                ...
                <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                  <div>
                    ...
                    <p class="text-xs text-monokai-gutter ">Show "Inner blocks use content width"</p>
                  </div>
                ...
                <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                  <div>
                    ...
                    <p class="text-xs text-monokai-gutter ">Vertical alignment controls (flex only)</p>
                  </div>
                ...
                <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
                  <div>
                    ...
                    <p class="text-xs text-monokai-gutter ">Justify controls (flex and constrained)</p>
                  </div>
                ...
                <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20 sm:col-span-2">
                  <div>
                    ...
                    <p class="text-xs text-monokai-gutter ">Orientation control (flex only)</p>
                  </div>
        ...
        <div>
          ...
          <p class="text-sm text-monokai-gutter  mb-5">Positioning controls for the block.</p>
          <div class="flex items-center justify-between gap-3 p-3 rounded-md border border-monokai-blue/20">
            <div>
              <p class="text-sm font-medium">Sticky Position</p>
              <p class="text-xs text-monokai-gutter ">Sticky position relative to its container</p>
            </div>
